...
sudo apt add-repository -y ppa:nextcloud-devs/client
...
sudo sh -c 'echo "deb https://mirror-ppa.aiursoft.cn/mozillateam/ppa/ubuntu/ $(lsb_release -sc) main" > /etc/apt/sources.list.d/mozilla.list'
