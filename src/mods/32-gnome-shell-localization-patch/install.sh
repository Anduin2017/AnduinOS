...
EOL
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "添加到任务栏"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "加入工作列"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "加入工作欄"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "タスクバーに追加"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "작업표시줄에 추가"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Thêm vào thanh tác vụ"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "เพิ่มไปยังแถบงาน"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Zur Taskleiste hinzufügen"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Ajouter à la barre des tâches"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Agregar a la barra de tareas"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Добавить на панель задач"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Aggiungi alla barra delle applicazioni"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Adicionar à barra de tarefas"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "إضافة إلى شريط المهام"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Toevoegen aan taakbalk"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Lägg till i aktivitetsfältet"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Dodaj do paska zadań"/}' /tmp/gnome-shell.po
    ...
    sed -i '/msgid "Pin to Dash"/{n;s/.*/msgstr "Görev çubuğuna ekle"/}' /tmp/gnome-shell.po
