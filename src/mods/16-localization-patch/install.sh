...
sed -i "/^Name=/a Name[zh_HK]=圖庫" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[ja_JP]=写真" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[ko_KR]=사진" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[fr_FR]=Photos" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[de_DE]=Fotos" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[es_ES]=Fotos" /usr/share/applications/shotwell.desktop
...
sed -i "/^Name=/a Name[vi_VN]=Ảnh" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[th_TH]=รูปภาพ" /usr/share/applications/shotwell.desktop
...
sed -i "/^Name=/a Name[pl_PL]=Zdjęcia" /usr/share/applications/shotwell.desktop
sed -i "/^Name=/a Name[tr_TR]=Fotoğraflar" /usr/share/applications/shotwell.desktop
...
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[zh_HK]=圖庫" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[ja_JP]=写真" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[ko_KR]=사진" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[fr_FR]=Photos" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[de_DE]=Fotos" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[es_ES]=Fotos" /usr/share/applications/shotwell.desktop
...
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[vi_VN]=Ảnh" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[th_TH]=รูปภาพ" /usr/share/applications/shotwell.desktop
...
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[pl_PL]=Zdjęcia" /usr/share/applications/shotwell.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[tr_TR]=Fotoğraflar" /usr/share/applications/shotwell.desktop
judge "Patch Shotwell localization"

print_ok "Patching rhythmbox localization..."
sed -i "/^Name=Rhythmbox/a Name[zh_CN]=音乐" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[zh_TW]=音樂" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[zh_HK]=音樂" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[ja_JP]=音楽" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[ko_KR]=음악" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[fr_FR]=Musique" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[de_DE]=Musik" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[es_ES]=Música" /usr/share/applications/rhythmbox.desktop
...
sed -i "/^Name=Rhythmbox/a Name[vi_VN]=Âm nhạc" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[th_TH]=เพลง" /usr/share/applications/rhythmbox.desktop
...
sed -i "/^Name=Rhythmbox/a Name[pl_PL]=Muzyka" /usr/share/applications/rhythmbox.desktop
sed -i "/^Name=Rhythmbox/a Name[tr_TR]=Müzik" /usr/share/applications/rhythmbox.desktop
...
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[zh_HK]=音樂" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[ja_JP]=音楽" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[ko_KR]=음악" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[fr_FR]=Musique" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[de_DE]=Musik" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[es_ES]=Música" /usr/share/applications/rhythmbox.desktop
...
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[vi_VN]=Âm nhạc" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[th_TH]=เพลง" /usr/share/applications/rhythmbox.desktop
...
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[pl_PL]=Muzyka" /usr/share/applications/rhythmbox.desktop
sed -i "/^X-GNOME-FullName=/a X-GNOME-FullName[tr_TR]=Müzik" /usr/share/applications/rhythmbox.desktop
