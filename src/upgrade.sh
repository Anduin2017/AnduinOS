...
function main() {
    ...
    if [ "$CURRENT_VERSION" == "$LATEST_VERSION" ]; then
        ...
        print_ok "Please note: AnduinOS 1.3 will stop receiving updates on January 31, 2025."
        print_ok "Starting January 1, 2025, a script will be added to upgrade this system to AnduinOS 1.4."
        exit 0
    fi
